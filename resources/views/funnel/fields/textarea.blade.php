<div style="margin-bottom: 0.25rem;">
    ...
    <textarea
        ...
        rows="4"
        style="width: 100%; padding: 0.875rem 1.25rem; border: 1px solid var(--lp-border); border-radius: var(--lp-radius); font-size: 1rem; font-family: inherit; color: var(--lp-text); background: var(--lp-field-bg); outline: none; transition: border-color 0.2s, box-shadow 0.2s; resize: none; box-sizing: border-box; backdrop-filter: blur(4px);"
